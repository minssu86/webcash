...
public abstract class Block implements Serializable {
	...
	public abstract void setBlock(Label[][] playGroundArr);
	...
	private void checkGameOver() {
		if(a[0]<2 || b[0]<2 || c[0]<2 || d[0]<2) {
			...
			for(int i = 4; i < 9; i++) {
				playGroundArr[i][2].setBackground(Color.blue);
				playGroundArr[i][8].setBackground(Color.blue);
			}

			playGroundArr[7][8].setBackground(Color.white);
			playGroundArr[8][3].setBackground(Color.blue);
			playGroundArr[8][4].setBackground(Color.blue);
			playGroundArr[8][5].setBackground(Color.blue);
			playGroundArr[8][8].setBackground(Color.blue);
